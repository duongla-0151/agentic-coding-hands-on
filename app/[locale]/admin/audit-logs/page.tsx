    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-bold text-white">
          Audit Logs{' '}
          <span className="text-white/30 text-lg font-normal">({total})</span>
        </h1>
        <form className="flex gap-2">
          ...
          <button
            type="submit"
            className="px-3 py-2 text-sm text-white/50 hover:text-white border border-white/10 rounded-lg"
          >
            Filter
          </button>
        </form>
